namespace GestaoReservasCommand.Events
{
    public class EventName
    {
        ...
        public static EventName EmprestimoSobreposto { get { return new EventName("reserva_emprestimo_sobreposto"); } }
        public static EventName EmprestimoNaoSobreposto { get { return new EventName("reserva_emprestimo_nao_sobreposto"); } }
